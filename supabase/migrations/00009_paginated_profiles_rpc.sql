-- Paginated list of profiles with email (owner only). Supports search, role filter, and sort.
...
GRANT EXECUTE ON FUNCTION public.get_all_profiles_with_email_paginated(int, int, text, app_role, text, text) TO authenticated;
